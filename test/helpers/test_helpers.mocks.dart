...
// in fmp/test/helpers/test_helpers.dart.
...
import 'package:fmp/services/api_service.dart' as _i8;
...
class MockApiService extends _i1.Mock implements _i8.ApiService {
  ...
  @override
  _i6.Future<dynamic> fetchMostEmailed(int? days) => (super.noSuchMethod(
        Invocation.method(
          #fetchMostEmailed,
          [days],
        ),
